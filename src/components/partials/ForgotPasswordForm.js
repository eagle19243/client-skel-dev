              ...
              <div>
                ...
                <Form onSubmit={ this.forgotPasswordSubmit }>
                  <FormGroup>
                    ...
                    <Input type="text" name="authCode" id="authCode" placeholder="" onChange={this.handleChange} required />
                    <FormText>Check your spam folder if you do not see "Your verification code" email</FormText>
                  </FormGroup>
                  <FormGroup>
                    <Label for="new_password">New Password</Label>
                    <Input type="password" name="new_password" id="new_password" placeholder="" onChange={this.handleChange} required />
                  </FormGroup>
                  <Button color="primary">Submit</Button>
                </Form>
              </div>
